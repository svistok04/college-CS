...
if __name__ == '__main__':
    ...
    approx = MLPApproximator(structure=[128, 128, 64, 64, 32, 32], activation_name="relu", targets_activation_name="linear", initialization_name="uniform",
                             algo_name="adam", learning_rate=1e-2,
