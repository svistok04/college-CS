...
void Game::play() {
    ...
    int i;
    gracze[0] = Player("Bryanusz");
    gracze[1] = Player("Jessica");
    gracze[2] = Player("Nepomucen");
    ...
    do
    {
        ...
        {
            cout << "\033[1;34m" << kolo.kolo[i] << "\033[0m" << endl;
            kwota = kolo.kolo[i];
        }

        // Strata kolejki i bankrut
        if ((kolo.kolo[i] == 0) || (kolo.kolo[i] == -1))
        {
            if (kolo.kolo[i] == -1) // bankrut
